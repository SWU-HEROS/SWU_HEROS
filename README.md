...
* Level 1 (Identifiable): 모든 정보 포함 (전화번호, IMSI 등).
* Level 2 (Partially Masked): 전화번호 일부 마스킹(010-****-5432), IMSI 삭제, 나이 그룹화.
* Level 3 (Fully Masked): 전화번호/IMSI 완전 삭제, 나이대 광범위 일반화(Youth, Senior 등).
